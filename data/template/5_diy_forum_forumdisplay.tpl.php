...
0
|| checktplrefresh('./template/newry_ui/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1404647333, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/newry_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/newry_ui/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1404647333, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/newry_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/newry_ui/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1404647333, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/newry_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/newry_ui/forum/forumdisplay.htm', './template/newry_ui/forum/forumdisplay_list.htm', 1404647333, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/newry_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/newry_ui/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1404647333, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/newry_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/newry_ui/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1404647333, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/newry_ui', 'forum/forumdisplay')
|| checktplrefresh('./template/newry_ui/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1404647333, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/newry_ui', 'forum/forumdisplay')
...
<style type="text/css">
.newry_wp{ position:relative}
#pt{ background:#EFF2F5; height:46px; line-height:46px; margin:0}
#pt a{ height:46px; line-height:46px; font-weight:bold;}
#pt .z em{ margin-top:8px}
.ct2 .fl .bm,.bm {border-top:none; }
</style>
</div>
<div id="pt" class="bm cl">
   <div class="wp">
<div class="z">
<a href="./" title="首页"><?php echo $_G['setting']['bbname'];?></a><em>></em><a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?>
</div>
    </div>
</div>
<div id="wp" class="wp">
...
<div class="bml pbn forum_list_box">
...
<div class="boardnav">
<div id="ct" class="newry_wp cl<?php if($_G['forum']['allowside']) { ?> ct2<?php } ?>"<?php if($leftside) { ?> <?php } ?>>
        <div class="newry_right">
...
<?php if($leftside) { ?>
<div id="sd_bdl" class="bdl" onmouseover="showMenu({'ctrlid':this.id, 'pos':'dz'});" style="width:260px;">
     ...
     <div id="js_rizhipaihang_dl" class="rizhipaihang tt_hotlist">
        ...
        <h4 class="tT">
          <ul>
            <div class="view-hover tab SwapTab">
              ...
              <span class="spWid1 current fb" id="switchTab7_1"><a href="javascript:;" onmouseover="switchTab('switchTab7',1, 2 ,'fb'); this.blur();">最新帖子</a></span>
              <span class="spWid2" id="switchTab7_2"><a href="javascript:;" onmouseover="switchTab('switchTab7',2, 2 ,'fb'); this.blur();">热门帖子</a></span>
              </dt>
            </div>
          </ul>
        </h4>
      ...
      <div class="tC tab-content">
        <div class="view-hover tt_hot">
          <div class="switchItem" id="switchTab7_c_1" style="display:"> 
             <ul class="lxz_xiaozuhottie">
                <!--[diy=diy_lxz]--><div id="diy_lxz" class="area"></div><!--[/diy]-->
             </ul>
          </div>
          <div class="switchItem" id="switchTab7_c_2" style="display:none"> 
             <ul class="lxz_xiaozuhottie">
                 <!--[diy=diy_lxz2]--><div id="diy_lxz2" class="area"></div><!--[/diy]-->
             </ul>
          </div>
        </div>
      </div>
    </div>
       <!--[diy=diy_lxz_n]--><div id="diy_lxz_n" class="area"></div><!--[/diy]-->
        </div>
            
<div class="mn lbody newry_left">

...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1405354947, '4', './data/template/4_4_member_login.tpl.php', './template/mobanbus_mus', 'member/login')

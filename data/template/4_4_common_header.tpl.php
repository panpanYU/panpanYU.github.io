...
0
|| checktplrefresh('./template/mobanbus_mus/common/header.htm', './template/mobanbus_mus/common/header_common.htm', 1424349083, '4', './data/template/4_4_common_header.tpl.php', './template/mobanbus_mus', 'common/header')
|| checktplrefresh('./template/mobanbus_mus/common/header.htm', './template/mobanbus_mus/common/pubsearchform.htm', 1424349083, '4', './data/template/4_4_common_header.tpl.php', './template/mobanbus_mus', 'common/header')
;?>

...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1417010843, '4', './data/template/4_4_search_portal.tpl.php', './template/mobanbus_mus', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1417010843, '4', './data/template/4_4_search_portal.tpl.php', './template/mobanbus_mus', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1417010843, '4', './data/template/4_4_search_portal.tpl.php', './template/mobanbus_mus', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1417010843, '4', './data/template/4_4_search_portal.tpl.php', './template/mobanbus_mus', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/mobanbus_mus/common/header_common.htm', 1417010843, '4', './data/template/4_4_search_portal.tpl.php', './template/mobanbus_mus', 'search/portal')
;?>

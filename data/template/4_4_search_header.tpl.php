...
0
|| checktplrefresh('./template/default/search/header.htm', './template/mobanbus_mus/common/header_common.htm', 1427343295, '4', './data/template/4_4_search_header.tpl.php', './template/mobanbus_mus', 'search/header')
;?>

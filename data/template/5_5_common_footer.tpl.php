...
Powered by <a href="http://www.discuz.net" target="_blank">Discuz!</a><?php echo $_G['setting']['version'];?> , All rights reserved.<span></span><a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a> 版权所有<br/>
</div>
</div>
<!-- footer end --> 

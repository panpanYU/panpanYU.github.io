...
0
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/mobanbus_mus/common/header.htm', 1406793725, 'mobile', './data/template/4_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/mobanbus_mus/common/footer.htm', 1406793725, 'mobile', './data/template/4_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/mobanbus_mus/common/header_common.htm', 1406793725, 'mobile', './data/template/4_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/mobanbus_mus/common/pubsearchform.htm', 1406793725, 'mobile', './data/template/4_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
;?>
...
<!--[if lte IE 6]>
<script src="template/mobanbus_mus/mus_st/js/DD_belatedPNG_0.0.8a.js" type="text/javascript" type="text/javascript"></script>
...
<script src="template/mobanbus_mus/mus_st/js/mobanbus_pace.js" type="text/javascript"></script>
<script src="template/mobanbus_mus/mus_st/js/jquery-1.7.2.min.js" type="text/javascript"></script>
<script>
 function load(time){
...
<ul class="p_pop h_pop" id="plugin_menu" style="display: none"><?php if(is_array($_G['setting']['plugins']['jsmenu'])) foreach($_G['setting']['plugins']['jsmenu'] as $module) { ?> 
...
<div class="bodycontainer clearfix navcontainer cl"><?php echo adshow("headerbanner/wp a_h");?><?php echo adshow("subnavbanner/a_mu");?> 
<?php if(!empty($_G['setting']['pluginhooks']['global_header'])) echo $_G['setting']['pluginhooks']['global_header'];?>
<?php } ?>
<div id="wp" class="wp cl"><link rel="stylesheet" type="text/css" href="source/plugin/mobile/template/style.css" />
<?php if($_G['adminid'] == 1) { ?>
<script type="text/javascript">
function hiddentips() {
...
<span class="pipe">|</span>Design:<a href="http://www.mobanbus.cn" target="_blank">Mobanbus</a>
</p>
<p class="xs0">

...
0
|| checktplrefresh('./template/mobanbus_mus/common/header.htm', './template/mobanbus_mus/common/header_common.htm', 1404662165, '4', './data/template/4_4_common_header_forum_viewthread.tpl.php', './template/mobanbus_mus', 'common/header_forum_viewthread')
|| checktplrefresh('./template/mobanbus_mus/common/header.htm', './template/mobanbus_mus/common/pubsearchform.htm', 1404662165, '4', './data/template/4_4_common_header_forum_viewthread.tpl.php', './template/mobanbus_mus', 'common/header_forum_viewthread')
;?>

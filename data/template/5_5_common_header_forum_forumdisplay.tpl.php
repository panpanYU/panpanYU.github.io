...
0
|| checktplrefresh('./template/newry_ui/common/header.htm', './template/newry_ui/common/header_common.htm', 1404647333, '5', './data/template/5_5_common_header_forum_forumdisplay.tpl.php', './template/newry_ui', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/newry_ui/common/header.htm', './template/newry_ui/common/pubsearchform.htm', 1404647333, '5', './data/template/5_5_common_header_forum_forumdisplay.tpl.php', './template/newry_ui', 'common/header_forum_forumdisplay')
;?>
...
<?php } ?>    <div class="cl"></div>
  ...
  <script src="template/newry_ui/style/js/scrolltop.js" type="text/javascript" ></script>
  <!--End Navigation-->

...
/*
	...
	$Id: install.php 72 2011-09-16 02:01:12Z songlixin $
*/
...
REPLACE INTO cdb_prompttype (`key`, `name`, `script`) VALUES ('mynotice','{$installlang[manyou][prompttypenotice]}','userapp.php?script=notice');
REPLACE INTO cdb_prompttype (`key`, `name`, `script`) VALUES ('myinvite','{$installlang[manyou][prompttypeinvite]}','userapp.php?script=notice&action=invite');

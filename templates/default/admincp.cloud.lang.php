 ...
 *
 *	  $Id: admincp.cloud.lang.php 138 2011-09-22 04:48:37Z yexinhao $
 */
...
(
	...
	'cloud_status_error' => '出了点小错，由于站点ID/通信KEY等关键信息丢失导致Discuz!云平台服务出现异常，使用<a href="admincp.php?action=cloud&operation=doctor">诊断工具</a>检测站点ID和KEY，如有疑问请访问<a href="http://www.discuz.net/forum-3926-1.html" target="_blank">官方论坛</a>寻求帮助',
	...
	'cloud_unknown_dns' => '您的站点目前无法连接Discuz!云平台，请检查您服务器网络设置，使用<a href="admincp.php?action=cloud&operation=doctor">诊断工具</a>检测DNS解析和接口连通性。<a href="http://cp.discuz.qq.com/faq?fId=1305690058&ADTAG=CP.CLOUD.FAQ.FID" target="_blank">查看帮助</a>，如有疑问请访问<a href="http://www.discuz.net/forum-3926-1.html" target="_blank">官方论坛</a>求助',
	...
	'cloud_api_ip_comment' => '若站点服务器由于DNS解析问题无法连接到云平台接口，请填写api.discuz.qq.com的IP地址，使用<a href="admincp.php?action=cloud&operation=doctor">诊断工具</a>检测，<a href="http://cp.discuz.qq.com/faq?fId=1304068911&ADTAG=CP.CLOUD.FAQ.FID" target="_blank">查看帮助</a>',
	'cloud_manyou_ip' => '漫游接口IP',
	'cloud_manyou_ip_comment' => '若站点服务器由于DNS解析问题无法连接到漫游接口，请填写api.manyou.com的IP地址，使用<a href="admincp.php?action=cloud&operation=doctor">诊断工具</a>检测，<a href="http://faq.comsenz.com/viewnews-400" target="_blank">查看帮助</a>',
	'cloud_connect_api_ip' => 'QQ互联接口IP',
	'cloud_connect_api_ip_comment' => '若站点服务器由于DNS解析问题无法连接到QQ互联接口，请填写openapi.qzone.qq.com的IP地址，使用<a href="admincp.php?action=cloud&operation=doctor">诊断工具</a>检测，<a href="http://cp.discuz.qq.com/faq?fId=1316571929&ADTAG=CP.CLOUD.FAQ.FID" target="_blank">查看帮助</a>',
	...
	'cloud_doctor_result_success' => '<img align="absmiddle" src="images/admincp/cloud/right.gif" />',
	'cloud_doctor_result_failure' => '<img align="absmiddle" src="images/admincp/cloud/wrong.gif" /> ',
	...
	'cloud_doctor_dns_failure' => '<img align="absmiddle" src="images/admincp/cloud/wrong.gif" /> %s DNS解析失败 %s <a href="javascript:;" onClick="showWindow(\'cloudApiIpWin\', \'%s?action=cloud&operation=siteinfo&anchor=cloud_ip&callback=doctor\'); return false;">设置接口IP</a>',

	'cloud_doctor_title_plugin' => '系统插件检测',
	'cloud_doctor_system_plugin_status' => '系统插件状态',
	'cloud_doctor_system_plugin_list' => '<a href="admincp.php?action=plugins">查看插件列表和版本</a>',
	'cloud_doctor_system_plugin_status_false' => ' 系统插件未初始化 <a href="admincp.php?action=cloud&operation=doctor&op=initsys" target="_doctor_initframe" onClick="$(\'_doctor_initframe\').onload = function () {self.location.reload();};">点击修复</a><iframe id="_doctor_initframe" name="_doctor_initframe" src="" width="0" height="0" style="display:none;"></iframe>',
	...
	'cloud_doctor_connect_reopen' => '当前站点appid/appkey丢失，请<a href="admincp.php?action=cloud&operation=applist">重新开通</a>QQ互联',
	...
	'setting_manyou_index_limit' => '首页应用推荐条目数',
	'setting_manyou_index_limit_comment' => '设置首页显示推荐应用条目数，0 为不显示',
	'setting_manyou_extcredit' => 'MYOP 应用使用的积分',
	'setting_manyou_feedpp' => '首页每页动态条目数',
	...
	'connect_api_ip' => 'QQ互联接口IP',
	'connect_api_ip_comment' => '如站点服务器由于DNS解析问题无法连接到QQ互联接口，请尝试填写IP地址，<a href="{getipurl}" target="_blank">获取IP地址</a>',
	'connect_appid' => '站点Id',
	'connect_appid_comment' => '没有站点Id和站点Key？<a href="{applyappidurl}" target="_blank">点击申请</a> <a href="{findappidurl}" target="_blank">找回</a>',
	'connect_appkey' => '站点Key',
	'connect_invalid_appkey' => '无效的站点Key',
	'connect_setting_update_succeed' => 'QQ互联设置保存成功',
	...
	'qqgroup_preview_tips_topic' => '点击左侧 <img src="images/admincp/cloud/qun_op_top.png" align="absmiddle" /> 将信息推送到头条',
	'qqgroup_preview_tips_normal' => '点击左侧 <img src="images/admincp/cloud/qun_op_list.png" align="absmiddle" /> 将信息推送到列表',
	'qqgroup_preview_more' => '更多',
	'qqgroup_preview_shortname' => '页卡标题',
	'qqgroup_preview_button' => '推送信息',
	'attach_img' => '图片附件',

	'manyou_setting_update_succeed' => '漫游应用设置保存成功',
	'manyou_uchome_exists' => '您的论坛安装了 UCenter Home，无法使用本功能。',
	'my_app_status_off' => '请先正常开启漫游功能',
	'loading' => '页面加载中',
	'setting_update_succeed' => '当前设置更新成功',
	'myop_error' => '用户应用服务开启失败，失败原因：<br>{errMessage} (ERRCODE:{errCode})<br><br><a href="http://www.discuz.net/index.php?gid=168" target="_blank">如果有疑问，请访问我们的技术论坛寻求帮助</a>。',
	'myop_close' => '用户应用服务已关闭。',
	'myop_open' => '用户应用服务已开启。',
	'myop_sync' => '站点信息已成功同步。',
